...
BOOST_AUTO_TEST_CASE(asset_claim_pool_test)
{
    try
    {
        ...
        // Alice deposits CREDIT to the fee pool
        ...
        // deposit 100 CREDIT to the fee pool of ALICEUSD asset
        ...
        // deposit 300 CREDIT to the fee pool of ALICECOIN asset
        ...
        // can claim CREDIT back from the fee pool
